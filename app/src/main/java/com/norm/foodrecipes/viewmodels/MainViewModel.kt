...
import com.norm.foodrecipes.data.Repository
...
/**
 * Main view model class with application.
 */
@HiltViewModel
class MainViewModel @Inject constructor(
    ...
    /** store response data to database for using offline cache */
    private fun offlineCacheRecipes(foodRecipe: FoodRecipe) {
        val recipesEntity = RecipesEntity(foodRecipe)
        insertRecipes(recipesEntity)
    }

    /** store food joke response data to database */
    ...
    /** Check the device has a internet connection. */
